...
const resolvePath = (folder, filename) =>
...
const paths = {
	...
	IOEOfficialPageNoticesPath: resolvePath(
		'ioe',
		'IOE_Official_Page_Notices.json'
	),
	IOEAdmissionNoticesPath: resolvePath('ioe', 'IOE_Admission_Notices.json'),
	IOMOfficialPageNoticesPath: resolvePath(
		'iom',
		'IOM_Official_Page_Notices.json'
	),
	IOMRoutineNoticesPath: resolvePath('iom', 'IOM_Routine_Notices.json')
};
